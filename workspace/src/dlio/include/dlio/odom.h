...
private:
  ...
  void callbackPointCloud(const livox_ros_driver2::CustomMsg::ConstPtr &pc);
  ...
  void getScanFromROS(const livox_ros_driver2::CustomMsg::ConstPtr& pc);
  ...
  nav_msgs::Odometry odom_base_ros;
  ...
  // Transformations
  Eigen::Matrix4f T, T_prior, T_corr, T_discrepency;
  ...
  bool lidar_unreliable = false;

  bool use_imu_update = false;

  int use_imu_cooldown_cnt = 0;
